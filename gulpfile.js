...
var sources = [
    ...
    './src/image-decoder/image-decoder-workers/worker-proxy-fetch-manager.js',
    './src/image-decoder/image-decoder-workers/worker-proxy-image-decoder.js',
    './src/image-decoder/image-decoder.js',
    './src/image-decoder/image-decoder-viewer.js',
    './src/simple-fetcher/simple-movable-fetch.js',
    './src/simple-fetcher/simple-fetcher-base.js',
    ...
    './src/simple-fetcher/grid-level-calculator.js',
...
var vendorsProd = [
    './vendor/dependency-workers.dev.js'
];

var vendorsDebug = [
    './vendor/dependency-workers.dev.debug.js'
];
